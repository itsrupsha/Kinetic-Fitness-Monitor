                    ...
                    {step === 1 && (
                        <div className="space-y-6">
                            <div className="flex items-center gap-4 mb-8">
                                <div className="size-12 rounded-xl bg-emerald-50
                                dark:bg-emerald-900/10 border border-emerald-100
                                dark:border-emerald-800 flex items-center
                                justify-center">
                            ...
                            <div className="space-y-8 max-w-lg">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <Slider label="Daily Calorie Intake"
                                        min={120}
                                        max={4000} step=
                                        {50} value={formData.dailyCalorieIntake} onChange={(v) => updateField
                                            ('dailyCalorieIntake', v)} unit="Kcal"
                                        infoText="The total
                             Calories you plan to consume each day "/>

                                    <Slider label="Daily Calorie Burn"
                                        min={100}
                                        max={2000} step=
                                        {50} value={formData.dailyCalorieBurn} onChange={(v) => updateField
                                            ('dailyCalorieBurn', v)} unit="Kcal"
                                        infoText="The total
                             calories you aim to burn through exercise and activity each day ."/>
